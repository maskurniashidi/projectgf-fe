        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
          ...
          <li className="relative">
            <button className="rounded-full focus:shadow-outline-purple focus:outline-none" onClick={handleProfileClick} aria-label="Account" aria-haspopup="true">
              <Avatar className="align-middle" src="https://deejayfarm.com/wp-content/uploads/2019/10/Profile-pic.jpg" alt="" aria-hidden="true" />
            </button>
            <Dropdown align="right" isOpen={isProfileMenuOpen} onClose={() => setIsProfileMenuOpen(false)}>
              {/* <DropdownItem tag={Link} to="/app/profile" href="/Profile">
                <OutlinePersonIcon className="w-4 h-4 mr-3" aria-hidden="true" />
                <span>Profile</span>
              </DropdownItem> */}
              {/* <DropdownItem tag={Link} to="/app/edit-profile" href="/edit-profile">
